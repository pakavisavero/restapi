...
app.get('/users', function (req, res) {
    dbConn.query('SELECT * FROM mahasiswa', function (error, results, fields) {
...
app.get('/user/:id', function (req, res) {
    ...
    dbConn.query('SELECT * FROM users where id_mahasiswa=?', user_id, function (error, results, fields) {
        if (error) throw error;
